<map name="home-map-map" id="home-map-map">
...
<a id="home-map-tickets" class="home-map-button" href="<?php echo get_permalink(8); ?>">
	<span class="home-map-button-decor-left" ></span>
	<i></i>Tickets
	<span class="home-map-button-decor-right" ></span>
</a>
<a id="home-map-travel-connections" class="home-map-button" href="<?php echo get_permalink(12); ?>">
	<span class="home-map-button-decor-left" ></span>
	<i></i>Travel Connections
	<span class="home-map-button-decor-right" >
	</span>
</a>
<?php 
